                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="blog-post">
                                ...
                                <div class="post-info">
                                    ...
                                    <p class="post-excerpt"> <?= ucfirst(substr($nov['desarrollo'], 0, 250)); ?>...</p>
                                </div>
                                ...
                                <div class="blog-meta">
                                    <div class="share-icons">
                                        <ul>
                                            ...
                                            <li>
                                                <a class="resp-sharing-button__link" href="https://pinterest.com/pin/create/button/?url=<?=URL?>" target="_blank" aria-label="">
